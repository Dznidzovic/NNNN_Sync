...
* @usage		  : Component to be used as a quick action button on ht_Producer__c records
* @params		  : recordId - Id of the ht_Producer__c record
* @events		  :
...
import PRODUCER_NPN from "@salesforce/schema/ht_Producer__c.ht_NPN__c";
import PRODUCER_LAST_SYNC from "@salesforce/schema/ht_Producer__c.ht_LastNIPRSync__c";
